...
def ecra3(): #variaveis das Entrys: nome, apelido, nickname, email, data, password, confirmpass, erro
    ...
    tk.Label(window2, text="Email:", font=("", 15)).place(x=350, y=130)
    email = tk.Entry(window2, width=35)
    email.place(x=410, y=137)
    tk.Label(window2, text="Data de nascimento:", font=("", 15)).place(x=50, y=170)
